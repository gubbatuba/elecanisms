...
class simpleapp_tk(Tkinter.Tk):
    ...
    def initialize(self):
        ...
        button_k = Tkinter.Button(self, text=u"Set k",
                                command=self.set_spring_constant)
        button_k.grid(column=0, row=4)
    ...
    def set_spring_constant(self):
        new_constant = self.spring_constant_scale.get()
...
if __name__ == "__main__":
    ...
    app.title('Haptic Spring Control')
    app.mainloop()
